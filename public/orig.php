    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3 class="section-subheading text-muted">A city with constituents who value a healthy lifestyle and actively participate in community healh development brought about by competent and committed health workers who promote well-being and protect the health if its citizens.</h3>
        </div>
        <hr>
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Mission</h2>
          <h3 class="section-subheading text-muted">To implement the DOH programs and create the proper physical and social environments, expanding communiy resource and developing health workers to their maximun potentials.</h3>
        </div>
      </div>
      <hr>
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Guiding Principles</h2>
